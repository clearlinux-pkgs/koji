...
Patch14: 0014-Stop-use-of-function-seemingly-removed-in-python-3.1.patch
...
%prep
%setup -q -n koji-koji-1.29.1
cd %{_builddir}/koji-koji-1.29.1
%patch1 -p1
%patch2 -p1
%patch3 -p1
%patch4 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1666841276
