...
Source0  : https://pagure.io/koji/archive/koji-1.33.0/koji-koji-1.33.0.tar.gz
...
BuildRequires : pypi(flake8_import_order)
...
Patch11: 0011-Remove-unneeded-dep-rpm-py-installer.patch
...
%prep
%setup -q -n koji-koji-1.33.0
cd %{_builddir}/koji-koji-1.33.0
%patch -P 1 -p1
%patch -P 2 -p1
%patch -P 3 -p1
%patch -P 4 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1685643483
