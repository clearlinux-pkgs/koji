...
BuildRequires : requests-gssapi
BuildRequires : requests-kerberos
BuildRequires : requests-mock
BuildRequires : rpm
BuildRequires : rpm-py-installer
BuildRequires : six
...
%prep
%setup -q -n koji-koji-1.26.0
cd %{_builddir}/koji-koji-1.26.0
%patch1 -p1
%patch2 -p1
%patch3 -p1
%patch4 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1630020809
...
cp %{_builddir}/koji-koji-1.26.0/COPYING %{buildroot}/usr/share/package-licenses/koji/c4b884eb09c7b65e2a469c7dbaf2f927e2af8e9f
