...
Source0  : https://pagure.io/koji/archive/koji-1.21.2/koji-koji-1.21.2.tar.gz
...
Patch8: 0008-Fix-isAlive-is_alive-for-python3.9.patch
...
%prep
%setup -q -n koji-koji-1.21.2
cd %{_builddir}/koji-koji-1.21.2
%patch1 -p1
%patch2 -p1
%patch3 -p1
%patch4 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1618452411
...
cp %{_builddir}/koji-koji-1.21.2/COPYING %{buildroot}/usr/share/package-licenses/koji/c4b884eb09c7b65e2a469c7dbaf2f927e2af8e9f
