...
Version  : 1.20.1
Release  : 132
URL      : https://pagure.io/koji/archive/koji-1.20.1/koji-koji-1.20.1.tar.gz
Source0  : https://pagure.io/koji/archive/koji-1.20.1/koji-koji-1.20.1.tar.gz
...
%prep
%setup -q -n koji-koji-1.20.1
cd %{_builddir}/koji-koji-1.20.1
%patch1 -p1
%patch2 -p1
%patch3 -p1
%patch4 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1585604388
...
cp %{_builddir}/koji-koji-1.20.1/COPYING %{buildroot}/usr/share/package-licenses/koji/c4b884eb09c7b65e2a469c7dbaf2f927e2af8e9f
